      ...
      <CardContent className="flex flex-col items-center gap-5 py-12 text-center">
        ...
        <div className="max-w-md space-y-2">
          ...
          <p className="text-sm text-muted-foreground">
            Domain Overview bills per request via x402.{" "}
            {canPay
              ? `Approve the payment to pull the full snapshot for ${target}.`
              : "Connect a wallet with USDC on Base to pay and run the report."}
          </p>
        </div>
